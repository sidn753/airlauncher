...
public class MuPDFActivity extends BaseActionBarActivity
        implements FilePicker.FilePickerSupport
{
            ...
            protected void onHit(Hit item)
            {
                ...
                case Annot:
                    if (item == Hit.Annotation)
                    {
                        ...
                        mTopBarSwitcher.setDisplayedChild(
                                mTopBarMode.ordinal());
                    }
                    break;
                case Delete:
                ...
                default:
                    ...
                    MuPDFView pageView =
                            (MuPDFView) mDocView.getDisplayedView();
                    if (pageView != null)
                    {
    ...
    private void setButtonEnabled(ImageButton button, boolean enabled)
    {
        ...
        button.setColorFilter(enabled ? Color.argb(255, 255, 255, 255)
    ...
    private void showButtons()
    {
        ...
        if (!mButtonsVisible)
        {
            ...
            Animation anim =
                    new TranslateAnimation(0, 0, mPageSlider.getHeight(), 0);
            anim.setDuration(200);
            anim.setAnimationListener(new Animation.AnimationListener()
            {
                public void onAnimationStart(Animation animation)
    ...
    private void hideButtons()
    {
        if (mButtonsVisible)
        {
            ...
            Animation anim =
                    new TranslateAnimation(0, 0, 0, mPageSlider.getHeight());
            anim.setDuration(200);
            anim.setAnimationListener(new Animation.AnimationListener()
            {
                public void onAnimationStart(Animation animation)
    ...
    private void updatePageNumView(int index)
    {
        ...
        mPageNumberView.setText(
                String.format("%d / %d", index + 1, core.countPages()));
    }
    ...
    private void showInfo(String message)
    {
        ...
        if (currentApiVersion >= android.os.Build.VERSION_CODES.HONEYCOMB)
        {
            SafeAnimatorInflater safe =
                    new SafeAnimatorInflater((Activity) this, R.animator.info,
                            (View) mInfoView);
        }
        else
        {
    ...
    private void makeButtonsView()
    {
        ...
        mReflowButton =
                (ImageButton) mButtonsView.findViewById(R.id.reflowButton);
        mOutlineButton =
                (ImageButton) mButtonsView.findViewById(R.id.outlineButton);
        mAnnotButton =
                (ImageButton) mButtonsView.findViewById(R.id.editAnnotButton);
    ...
    public void onBackPressed()
    {
        if (core != null && core.hasChanges())
        {
            ...
            alert.setMessage(
                    getString(R.string.document_has_changes_save_them_));
            alert.setButton(AlertDialog.BUTTON_POSITIVE,
                    getString(R.string.yes), listener);
