 ...
 * @TODO
 */
public class Common6ImageLayout extends LinearLayout
{
    Context mContext;

    CommonImage[] imgs = new CommonImage[6];
    public Common6ImageLayout(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        initControl(context);
    }

    public Common6ImageLayout(Context context)
    {
        super(context);
        initControl(context);
    }
    ...
    {
        mContext = context;
        inflate(getContext(), R.layout.custom_view_6_images_layout, this);
        ...
        imgs[4] = (CommonImage) this.findViewById(R.id.img4);
        imgs[5] = (CommonImage) this.findViewById(R.id.img5);
    }
