package com.rayboot.airlauncher.homeselector;
...
import com.rayboot.airlauncher.activity.MyActivity;
...
public class HomeManager
{
    ...
    public void removeDefaultHome(Context cont, Class<?> actClz)
    {
        ...
        ComponentName mhCN = new ComponentName(cont.getPackageName(),
                mkClz.getName());
        System.out.println("1111111   mhCN = " + mhCN.toString());
    ...
    public ComponentName queryDefaultHome()
    {
        ...
        for (int i = 0; i < cnList.size(); i++)
        {
            ...
            if (dhIF.hasAction(Intent.ACTION_MAIN) && dhIF.hasCategory(
                    Intent.CATEGORY_HOME) && dhIF.hasCategory(
    ...
    public int seekDefaultHome(List<HomeInfo> hInfos)
    {
        ...
        return (dhCN != null) ? seekDefaultHome(hInfos, dhCN.getPackageName())
                : -1;
    }
    ...
    public int seekDefaultHome(List<HomeInfo> hInfos, String pkgName)
    {
        ...
        {
            if (hInfos.get(i).checkDefault(pkgName))
            {
                return i;
            }
        }
